...
public class Test_Practice extends BaseTest
{
	HomePage homePage;
        ...
        public void  IntegrationToken(Map<String, String> data) throws Throwable
    {
            ...
            agentPage=homePage.selectAgentFromMenuBar();
            agentPage.clickReady();
			 ...
			 * 
			 * homePage.hoverAndSelectFromMenuBar("Project","Demo"); Thread.sleep(5000);
			 * 
			 ...
			 * 
			 * given() .baseUri(
			 * "https://api.testproject.io/v2/projects/5k19yA-XfkGI8q6e_MHbew/applications")
			 * .header("Authorization","LQtBI3QYKo7fY0Xi07WsTKGqdjd-FhTmvdgc7y0O4h81")
			 * .header("Content-Type", "application/json") // .body(requestParams)//
			 * "{\"name\":\"manik123\",\"platform\":\"Web\",\"url\":\"https://facebook.com\"}\n"
			 * + // "        ") .body(requestParams) .when() .post() .then()
